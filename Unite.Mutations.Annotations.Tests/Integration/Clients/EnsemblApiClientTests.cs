...
using Unite.Mutations.Annotations.Clients.Ensembl;
using Unite.Mutations.Annotations.Clients.Ensembl.Configuration.Options;
using Unite.Mutations.Annotations.Clients.Ensembl.Models.Constants;
using Unite.Mutations.Annotations.Clients.Ensembl.Resources;

namespace Unite.Mutations.Annotations.Tests.Integration.Clients
{
    [TestClass]
