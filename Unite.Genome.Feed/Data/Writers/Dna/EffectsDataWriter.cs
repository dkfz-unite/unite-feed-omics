...
public abstract class EffectsDataWriter<TAffectedTranscriptEntity, TVariantEntity, TVariantModel> : DataWriter<EffectsDataModel, EffectsDataWriteAudit>
    ...
    where TVariantModel : VariantModel
{
    ...
    protected EffectsDataWriter(IDbContextFactory<DomainDbContext> dbContextFactory) : base(dbContextFactory)
    {
    ...
    protected override void ProcessModel(EffectsDataModel effectsDataModel, ref EffectsDataWriteAudit audit)
    {
    ...
    protected override void ProcessModels(IEnumerable<EffectsDataModel> effectsDataModels, ref EffectsDataWriteAudit audit)
    {
