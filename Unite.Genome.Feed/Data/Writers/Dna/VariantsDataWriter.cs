...
public class VariantsDataWriter : DataWriter<SampleModel, VariantsDataWriteAudit>
{
    ...
    protected override void ProcessModel(SampleModel model, ref VariantsDataWriteAudit audit)
    {
    ...
    private void WriteSsms(int sampleId, IEnumerable<Models.Dna.Ssm.VariantModel> variantModels, ref VariantsDataWriteAudit audit)
    {
        ...
        var variantEntries = _ssmEntryRepository.CreateMissing(sampleId, variantModels, variants);
        audit.SsmsEntries.AddRange(variantEntries.Select(entry => entry.EntityId));
        audit.SsmsAssociated += variantEntries.Count();
    }

    private void WriteCnvs(int analysedSampleId, IEnumerable<Models.Dna.Cnv.VariantModel> variantModels, ref VariantsDataWriteAudit audit)
    {
    ...
    private void WriteSvs(int analysedSampleId, IEnumerable<Models.Dna.Sv.VariantModel> variantModels, ref VariantsDataWriteAudit audit)
    {
