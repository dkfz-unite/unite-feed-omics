...
public class EffectsDataSsmWriter : EffectsDataWriter<AffectedTranscript, Variant, Models.Dna.Ssm.VariantModel>
{
    public EffectsDataSsmWriter(IDbContextFactory<DomainDbContext> dbContextFactory) : base(dbContextFactory)
    {
    }
